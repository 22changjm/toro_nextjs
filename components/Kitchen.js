        ...
        <>  
                ...
                <div className={styles.menu}>
                    <div className={styles.col}>
                            <div className={styles.entry}>
                                <div className={styles.entryname}>Screaming Orgasm — 18.99</div>
                    ...
                    <div className={styles.col}>
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Yellowtail Jalapeno — 17.99</div>
                            <div className ={styles.entrydesc}>Yellowtail sashimi served with ponzu sauce, jalpeño slices &#38; masago</div>
                        </div>
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Salmon Steak — 21.99</div>
                    ...
                    <div className={styles.col}>
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Japanese Tacos — 14.99</div>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.menu}>
                    <div className={styles.col}>
                            <div className={styles.entry}>
                                <div className={styles.entryname}>Edamame — 4.99|6.99|7.99</div>
                            ...
                            <div className={styles.entry}>
                                <div className={styles.entryname}>Shrimp Wrap — 11.99</div>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.menu}>
                    <div className={styles.col}>
                            ...
                            <div className={styles.entry}>
                                <div className={styles.entryname}>Sunomono Salad — 5.99</div>
                    ...
                    <div className={styles.col}>
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Sashimi Salad — 18.99</div>
                            <div className ={styles.entrydesc}>Chef&#39;s choice of sashimi over mixed greens</div>
                        </div>
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Shrimp Avocado Salad — 17.99</div>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.menu}>
                    ...
                    <div className={styles.col}>
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Vegetable Tempura — 10.99</div>
                    ...
                    <div className={styles.col}>
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Combo Tempura — 12.99</div>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.menu}>
                    <div className={styles.col}>
                            <div className={styles.entry}>
                                <div className={styles.entryname}>Teriyaki — 14.99 | 16.99 | 18.99</div>
                                <div className ={styles.entrydesc}>Charbroiled Chicken | Beef | Salmon with house teriyaki sauce</div>
                            </div>
                            <div className={styles.entry}>
                                <div className={styles.entryname}>Tempura Combination — 18.99 | 19.99 | 20.99</div>
                    ...
                    <div className={styles.col}>
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Bulgogi — 17.99</div>
                        ...
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Spicy — 15.99 | 18.99</div>
                        ...
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Spicy Sauteed Pork — 16.99</div>
                    ...
                    <div className={styles.col}>
                        ...
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Don Katsu — 15.99</div>
                        ...
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Chicken Katsu — 15.99</div>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.menu}>
                    <div className={styles.col}>
                            <div className={styles.entry}>
                                <div className={styles.entryname}>Ramen Combo — 14.99</div>
                                <div className ={styles.entrydesc}>Korean style Ramen with choice of California Roll | Spicy Tuna Roll</div>
                            </div>
                            <div className={styles.entry}>
                                <div className={styles.entryname}>Kaki Udon — 12.99</div>
                    ...
                    <div className={styles.col}>
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Tempura Udon — 17.99</div>
                    ...
                    <div className={styles.col}>
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Yakisoba — 13.99|15.99|18.99</div>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.menu}>
                    <div className={styles.col}>
                            <div className={styles.entry}>
                                <div className={styles.entryname}>Toro Fried Rice — 13.99|14.99|15.99|16.99|17.99</div>
                                <div className ={styles.entrydesc}>Vegetable | Chicken | Beef | Shrimp| combo mixed with rice and vegetables</div>
                            </div>
                            <div className={styles.entry}>
                                <div className={styles.entryname}>Bacon Garlic Fried Rice — 16.99</div>
                    ...
                    <div className={styles.col}>
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Toro Fusion Bowl — 13.99|14.99|15.99</div>
                    ...
                    <div className={styles.col}>
                        ...
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Chirashi Bowl — 19.99</div>
                            <div className ={styles.entrydesc}>Chef’s choice of sashimi over steamed rice.</div>
                        </div>
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Sashimi Bowl — 20.99</div>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.menu}>
                    ...
                    <div className={styles.col}>
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Spicy Fish Stew — 17.95</div>
                    ...
                    <div className={styles.col}>
                        ...
                        <div className={styles.entry}>
                            <div className={styles.entryname}>Spicy Seafood Stew — 18.95</div>
